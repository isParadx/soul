...
const initCozeChat = () => {
  if (window.CozeWebSDK) {
    chatClient.value = new window.CozeWebSDK.WebChatClient({
      ...
      auth: {
        type: 'token',
        token: 'pat_3w5F0PWI8XkvvnUOA1Bs4JZg0GihE3Bzvl8rJEce82kyha2oUcjfttL9L6LNuyDG',
